...
let MAP_BLOCK_IMAGES = {};
for(let key in MAP_BLOCK_TYPES) {
    MAP_BLOCK_IMAGES[MAP_BLOCK_TYPES[key]] = new Image();
    MAP_BLOCK_IMAGES[MAP_BLOCK_TYPES[key]].src = `images/blocks/${key}.png`;
    MAP_BLOCK_IMAGES[MAP_BLOCK_TYPES[key]].onload = () => {
